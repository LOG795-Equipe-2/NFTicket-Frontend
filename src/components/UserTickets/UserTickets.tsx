import { Box, ButtonGroup, styled, Button, Collapse } from '@mui/material';
    ...
    return (
        <CssBox className="UserTickets">
            <div className="UserTickets__ticketsCarousel">
                <Carousel interval={10000} navButtonsAlwaysVisible animation="slide">
                    {event.ticketCategories.map((ticket, index) => (
                        <Box key={"my_ticket_" + index} className="UserTickets__ticketsCarousel__visualiserContainer">
            ...
            <div className="UserTickets__actions">
                <ButtonGroup>
                    <Button>Utiliser le billet <BookOnlineOutlinedIcon /></Button>
                    <Button onClick={toggleEventDetails}>Voir l'événement <ExpandMoreIcon /></Button>
                </ButtonGroup>
            </div>
